...
const Header = () => {
  ...
  const { runAsync: logout } = useRequest(loginService.logout, { manual: true });
    ...
    >
      ...
      >
        <div className="flex items-center gap-[4px] text-[20px] px-[24px] pr-0">
          ...
          <h1 className="text-primary font-bold text-[22px]">my-admin</h1>
        </div>
        <div
          className="btn-icon"
          onClick={() => {
              ...
              return (
                ...
                >
                  ...
                  <div className="p-[16px] text-center">
                    <Button onClick={handleLogout} type="text" size="small">
                      退出登录
                    </Button>
                  </div>
                </div>
