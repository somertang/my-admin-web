...
import {Button, Col, Form, FormInstance, Input, Modal, Popconfirm, Row, Space, Table, Tag, App} from 'antd';
...
const Index: React.FC = () => {
    ...
    const {tableProps, search} = useAntdTable(userService.getUserListByPage, {defaultPageSize: 10, form});
    ...
    return (
        <div>
            <Form form={form} size='large' className='dark:bg-[rgb(33,41,70)] bg-white p-[24px] rounded-lg'>
                <Row gutter={24}>
