          ...
          <div className="color-transition dark:bg-[rgb(33,41,70)] bg-white h-[600px] rounded-md p-[24px] relative">
            ...
            <div className="py-[24px]">
              <div>
                ...
                <div className="text-[rgb(0,200,83)] text-[12px] mt-[6px]">20% 利润</div>
              </div>
              ...
              <div>
                ...
                <div className="text-[rgb(216,67,21)] text-[12px] mt-[6px]">8% 亏损</div>
              </div>
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[16px]" />
              <div>
                <div className="flex justify-between items-center">
                ...
                <div className="text-[rgb(0,200,83)] text-[12px] mt-[6px]">14% 利润</div>
              </div>
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[16px]" />
              <div>
                <div className="flex justify-between items-center">
